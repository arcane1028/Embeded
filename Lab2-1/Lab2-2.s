...
;학번 : 201302480 이름 : 정석현
				...
				LDR	R1, =0 			; R1 레지스터에 0 저장 
				LDR	R2, =0 			; R2 레지스터에 0 저장, i의 역할
Loop_label
				CMP R2, #10 		; R2에 10뺀 결과를 flag에 반영
				BGE	Loop_end 	; 플래그 값이 0보다 크거나 같으면 루프 종료
				ADD R1, R1, R2	; R1에 R2를 더한 값을 R1에 저장
				ADD R2, R2, #1		; R2 레지스터 값을 1증가
				B		Loop_label	; 루프 반복
Loop_end 							; 루프 종료
